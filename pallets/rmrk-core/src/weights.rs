...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn burn_nft(n: u32) -> Weight {
		Weight::from_ref_time(1_725_000_000 as u64)
			.saturating_add(T::DbWeight::get().reads(81 as u64))
	...
	fn set_priority(n: u32, ) -> Weight {
		Weight::from_ref_time(23_106_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(2_661_000 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
