...
declare module '@polkadot/types/lookup' {
  ...
  export interface PalletRmrkCoreCall extends Enum {
    ...
    readonly asSend: {
      ...
      readonly newOwner: UpDataStructsRmrkAccountIdOrCollectionNftTuple;
    } & Struct;
    ...
    readonly type: 'CreateCollection' | 'DestroyCollection' | 'ChangeCollectionIssuer' | 'LockCollection' | 'MintNft' | 'BurnNft' | 'Send' | 'SetProperty' | 'AddBasicResource' | 'AddComposableResource' | 'AddSlotResource' | 'RemoveResource';
  }

  /** @name UpDataStructsRmrkAccountIdOrCollectionNftTuple (210) */
  ...
  /** @name UpDataStructsRmrkBasicResource (213) */
  ...
  /** @name UpDataStructsRmrkComposableResource (216) */
  ...
  /** @name UpDataStructsRmrkSlotResource (218) */
  ...
  /** @name UpDataStructsRmrkPartType (221) */
  ...
  /** @name UpDataStructsRmrkFixedPart (223) */
  ...
  /** @name UpDataStructsRmrkSlotPart (224) */
  ...
  /** @name UpDataStructsRmrkEquippableList (225) */
  ...
  /** @name UpDataStructsRmrkTheme (227) */
  ...
  /** @name EthereumTransactionTransactionV2 (237) */
  ...
  /** @name EthereumTransactionLegacyTransaction (238) */
  ...
  /** @name EthereumTransactionTransactionAction (239) */
  ...
  /** @name EthereumTransactionTransactionSignature (240) */
  ...
  /** @name EthereumTransactionEip2930Transaction (242) */
  ...
  /** @name EthereumTransactionAccessListItem (244) */
  export interface EthereumTransactionAccessListItem extends Struct {
    readonly address: H160;
    readonly storageKeys: Vec<H256>;
  }

  /** @name EthereumTransactionEip1559Transaction (245) */
  ...
  /** @name PalletEvmMigrationCall (246) */
  ...
  /** @name SpRuntimeDispatchError (251) */
  ...
  /** @name SpRuntimeModuleError (252) */
  export interface SpRuntimeModuleError extends Struct {
    readonly index: u8;
    readonly error: U8aFixed;
  }

  /** @name SpRuntimeTokenError (253) */
  ...
  /** @name SpRuntimeArithmeticError (254) */
  ...
  /** @name SpRuntimeTransactionalError (255) */
  ...
  /** @name FrameSystemAccountInfo (257) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassU64 (258) */
  ...
  /** @name SpRuntimeDigest (259) */
  export interface SpRuntimeDigest extends Struct {
    readonly logs: Vec<SpRuntimeDigestDigestItem>;
  }

  /** @name SpRuntimeDigestDigestItem (261) */
  ...
  /** @name FrameSystemEventRecord (263) */
  ...
  /** @name FrameSupportWeightsDispatchInfo (266) */
  ...
  /** @name FrameSupportWeightsDispatchClass (267) */
  ...
  /** @name FrameSupportWeightsPays (268) */
  ...
  /** @name OrmlVestingModuleEvent (269) */
  ...
  /** @name CumulusPalletXcmEvent (274) */
  ...
  /** @name CumulusPalletDmpQueueEvent (275) */
  ...
  export interface PalletRmrkCoreEvent extends Enum {
    ...
    readonly type: 'CollectionCreated' | 'CollectionDestroyed' | 'IssuerChanged' | 'CollectionLocked' | 'NftMinted' | 'NftBurned' | 'PropertySet' | 'ResourceAdded' | 'ResourceRemoval';
  }

  /** @name PalletRmrkEquipEvent (280) */
  ...
  /** @name EvmCoreErrorExitReason (284) */
  ...
  /** @name EvmCoreErrorExitSucceed (285) */
  ...
  /** @name EvmCoreErrorExitError (286) */
  ...
  /** @name EvmCoreErrorExitRevert (289) */
  export interface EvmCoreErrorExitRevert extends Enum {
    readonly isReverted: boolean;
    readonly type: 'Reverted';
  }

  /** @name EvmCoreErrorExitFatal (290) */
  ...
  /** @name FrameSystemLastRuntimeUpgradeInfo (293) */
  export interface FrameSystemLastRuntimeUpgradeInfo extends Struct {
    readonly specVersion: Compact<u32>;
    readonly specName: Text;
  }

  /** @name FrameSystemLimitsBlockWeights (294) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassWeightsPerClass (295) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (296) */
  ...
  /** @name FrameSystemLimitsBlockLength (298) */
  export interface FrameSystemLimitsBlockLength extends Struct {
    readonly max: FrameSupportWeightsPerDispatchClassU32;
  }

  /** @name FrameSupportWeightsPerDispatchClassU32 (299) */
  ...
  /** @name FrameSupportWeightsRuntimeDbWeight (300) */
  export interface FrameSupportWeightsRuntimeDbWeight extends Struct {
    readonly read: u64;
    readonly write: u64;
  }

  /** @name SpVersionRuntimeVersion (301) */
  ...
  /** @name CumulusPalletXcmError (323) */
  export type CumulusPalletXcmError = Null;

  /** @name CumulusPalletDmpQueueConfigData (324) */
  export interface CumulusPalletDmpQueueConfigData extends Struct {
    readonly maxIndividual: u64;
  }

  /** @name CumulusPalletDmpQueuePageIndexData (325) */
  ...
  /** @name UpDataStructsCollection (333) */
  ...
  /** @name UpDataStructsSponsorshipState (334) */
  ...
  /** @name PhantomTypeUpDataStructs (349) */
  ...
  /** @name UpDataStructsTokenData (351) */
  export interface UpDataStructsTokenData extends Struct {
    readonly properties: Vec<UpDataStructsProperty>;
    readonly owner: Option<PalletEvmAccountBasicCrossAccountIdRepr>;
  }

  /** @name UpDataStructsRpcCollection (353) */
  ...
  /** @name UpDataStructsRmrkCollectionInfo (354) */
  ...
  /** @name UpDataStructsRmrkNftInfo (355) */
  ...
  export interface PalletRmrkCoreError extends Enum {
    ...
    readonly type: 'CorruptedCollectionType' | 'NftTypeEncodeError' | 'RmrkPropertyKeyIsTooLong' | 'RmrkPropertyValueIsTooLong' | 'CollectionNotEmpty' | 'NoAvailableCollectionId' | 'NoAvailableNftId' | 'CollectionUnknown' | 'NoPermission' | 'CollectionFullOrLocked' | 'ResourceDoesntExist';
  }
