...
export default {
  ...
  /**
   * Lookup17: frame_system::EventRecord<rmrk_substrate_runtime::RuntimeEvent, primitive_types::H256>
   **/
  ...
  /**
   * Lookup43: rmrk_traits::nft::AccountIdOrCollectionNftTuple<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup167: rmrk_traits::nft::NftInfo<sp_core::crypto::AccountId32, sp_arithmetic::per_things::Permill, sp_core::bounded::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup176: rmrk_traits::nft::NftChild
   **/
